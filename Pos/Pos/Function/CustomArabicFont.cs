...
{
    internal class CustomArabicFont
    {
        ...
        public static void LoadCustomFont(float fontSize = 10.0F, bool isBold = false)
        {
            ...
            byte[] fontData = Properties.Resources.VIPSAMIRv2; // Ensure this matches the resource name
        ...
        public static bool isArabicData()
        {
            return false; // must be dynamic using settings
        }
    }
}
