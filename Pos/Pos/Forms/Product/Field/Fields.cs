...
{
    public partial class Fields : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public Fields()
        {
            ...
            gridViewFields.MouseUp += gridView_MouseUp;

            this.toRtl();
            this.BorderStyle();

            // style the grid view
            gridViewFields.RowStyle += gridViewFields_RowStyle;
            gridViewFields.FocusedRowChanged += gridViewFields_FocusedRowChanged;
            gridViewFields.CustomDrawCell += gridViewFields_CustomDrawCell;
            gridViewFields.RowHeight = Function.Helper.RowHeight;
            gridViewFields.ColumnPanelRowHeight = Function.Helper.ColumnPanelRowHeight;
        }

        // style the grid view
        private void gridViewFields_RowStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                ...
                if (e.RowHandle == gridViewFields.FocusedRowHandle)
                {
        ...
        private void gridViewFields_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            if (e.RowHandle == gridViewFields.FocusedRowHandle && e.Column == gridViewFields.FocusedColumn)
            {
        ...
        private void gridView_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                if (gridViewFields.RowCount > 0 && gridViewFields.FocusedRowHandle >= 0)
                {
                    GridView view = sender as GridView;
        ...
        private void MenuItemAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                AddEditField addEditField = new AddEditField();
                //addEditField.setFieldsObject(this);
                addEditField.setTypeOperation("Add");
        ...
        public void loadFields()
        {
            using (var context = new AppDbContext())
            {
                ...
                int totalItems = context.ProductFields
        ...
        private void BindDataToGrid(int pageNumber)
        {
            using (var context = new AppDbContext())
            {
                ...
                var currentPageData = context.ProductFields
                    .Where(p => p.Name.Contains(searchTerm))
                ...
                gridControlFields.DataSource = currentPageData;
                UpdatePageLabel();
        ...
        {
            this.field_id = int.Parse(gridViewFields.GetRowCellValue(gridViewFields.FocusedRowHandle, "Id").ToString());
            Function.Sound.Selected();
            this.fieldEdit();
        }

        private void repEditField_Click(object sender, EventArgs e)
        {
            this.field_id = int.Parse(gridViewFields.GetRowCellValue(gridViewFields.FocusedRowHandle, "Id").ToString());
            Function.Sound.Selected();
            this.fieldEdit();
        ...
        private void repDeleteField_Click(object sender, EventArgs e)
        {
            this.fieldDelete();
        }

        private void gridViewFields_RowClick(object sender, EventArgs e)
        {
            this.field_id = int.Parse(gridViewFields.GetRowCellValue(gridViewFields.FocusedRowHandle, "Id").ToString());
            Function.Sound.Selected();
        }
        ...
        public void fieldEdit()
        {
            ...
            addEditField.setFieldsObject(this);
            addEditField.setTypeOperation("Edit");
            addEditField.Show();
        ...
        public void fieldDelete()
        {
            ...
            Models.ProductField field = Shared.db.ProductFields.Find(this.field_id);

            if (field != null & XtraMessageBox.Show("Are you sure want to delete Item ?", "Confirmation", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                Shared.db.ProductFields.Remove(field);
        ...
        {
            Sound.Added();
            gridControlFields.ShowPrintPreview();
        }
        ...
        private void perPage_EditValueChanged(object sender, EventArgs e)
        {
            if (int.TryParse(perPage.SelectedItem.ToString(), out int newItemsPerPage))
            {
                using (var context = new AppDbContext())
                {
                    ...
                    int totalItems = context.ProductFields.Count();
                    totalPages = (int)Math.Ceiling((double)totalItems / itemsPerPage);
                    BindDataToGrid(currentPage);
                }
            }
        ...
        {
            GridExporter.Export(gridControlFields, "csv");
        }

        private void btnExportPdf_Click(object sender, EventArgs e)
        {
            GridExporter.Export(gridControlFields, "pdf");
        }

        private void btnExportXlsx_Click(object sender, EventArgs e)
        {
            GridExporter.Export(gridControlFields, "xlsx");
        }
