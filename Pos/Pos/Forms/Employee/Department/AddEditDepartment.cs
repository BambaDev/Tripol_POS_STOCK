...
{
    public partial class AddEditDepartment : DevExpress.XtraEditors.XtraForm
    {
        public Departments departments = null;
        ...
        public AddEditDepartment(AddEditEmployee addEditEmploye)
        {
            InitializeComponent();
            isEditEmployee = true;
        ...
        public void setDepartmentsObject(Departments departments)
        {
            ...
            if (this.departments != null)
            {
                using (var context = new AppDbContext())
                {
                    if (this.departments.department_id != 0)
                        this.currentItemId = this.departments.department_id;

                    this.departments.department_id = 0;

                    Models.Department department = context.Departments.Find(this.currentItemId);
            ...
            if (dxValidationProvider.Validate())
            {
                using (var context = new AppDbContext())
                {
                    ...
                    else
                    {
                        ...
                        department = context.Departments.Find(this.currentItemId);
                    ...
                    if (isEditEmployee)
                    {
                        addEditEmployee.setDepartment(department.Id);
                        this.Close();
                    }
                    if (this.departments != null)
        ...
        private Models.Department GetCurrentData()
        {
            using (var context = new AppDbContext())
            {
                if (currentItemId != 0)
                    return context.Departments.Find(currentItemId);
                else
                    return null;
            }
        }
        ...
        private void DisplayCurrentItem()
        {
            using (var context = new AppDbContext())
            {
                ...
                int minId = context.Departments.Min(b => b.Id);
                int maxId = context.Departments.Max(b => b.Id);
                ...
                Models.Department currentBrand = GetCurrentData();

                if (currentBrand != null)
                {
                    this.currentItemId = currentBrand.Id;
                    txtName.Text = currentBrand.DepartmentName;
                    btnSelect.Enabled = true;
                }
                else
                {
        ...
        private void MoveToFirst()
        {
            ...
            try
            {
                using (var context = new AppDbContext())
                {
                    int? minId = context.Departments.Min(b => (int?)b.Id);
                    if (minId.HasValue)
                    {
        ...
        private void MoveToLast()
        {
            ...
            try
            {
                using (var context = new AppDbContext())
                {
                    int? maxId = context.Departments.Max(b => (int?)b.Id);
                    if (maxId.HasValue)
                    {
        ...
        private void MoveToNext()
        {
            using (var context = new AppDbContext())
            {
                ...
                var nextBrand = context.Departments.Where(b => b.Id > currentItemId).OrderBy(b => b.Id).FirstOrDefault();
                if (nextBrand != null)
                {
                    currentItemId = nextBrand.Id;
                    DisplayCurrentItem();
                }
            }
        }
        ...
        private void MoveToPrevious()
        {
            using (var context = new AppDbContext())
            {
                if (currentItemId != 0)
                {
                    var prevBrand = context.Departments.Where(b => b.Id < currentItemId).OrderByDescending(b => b.Id).FirstOrDefault();
                    if (prevBrand != null)
                    {
                        currentItemId = prevBrand.Id;
                        DisplayCurrentItem();
                    }
                }
            }
        ...
        private void InitializeSearchLookUpEdit()
        {
            ...
            using (var context = new AppDbContext())
            {
                ...
                searchLookUpEdit.Properties.DataSource = context.Departments.ToList();
                searchLookUpEdit.Properties.DisplayMember = "DepartmentName";  // Display member is the Brand Name
                ...
                searchLookUpEdit.Properties.View.Columns.AddVisible("DepartmentName", name);
